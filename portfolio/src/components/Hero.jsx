      ...
      <div className="hero-content">
        ...
        <div className="hero-visual">
          ...
          <div className="hero-code-block">
            <div className="code-line"><span className="code-kw">const</span> <span className="code-variable">developer</span> = <span className="code-kw">new</span> <span className="code-fn">Developer</span>()</div>
            <div className="code-line"><span className="code-kw">while</span> (<span className="code-variable">developer</span>.<span className="code-fn">isCoding</span>()) <span className="code-kw">{'{'}</span></div>
            <div className="code-line indent"><span className="code-variable">developer</span>.<span className="code-fn">learn</span>()</div>
            <div className="code-line indent"><span className="code-variable">developer</span>.<span className="code-fn">build</span>()</div>
            <div className="code-line indent"><span className="code-variable">developer</span>.<span className="code-fn">improve</span>()</div>
            <div className="code-line"><span className="code-kw">{'}'}</span></div>
          </div>
        </div>
      </div>
    </section>
